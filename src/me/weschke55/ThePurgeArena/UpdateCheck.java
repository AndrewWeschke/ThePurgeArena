...
public class UpdateCheck {
	 ...
	 private Plugin plugin;
	    ...
	    private static final String USER_AGENT = "Updater (by Weschke55)";
	    ...
	    public UpdateCheck(Plugin plugin, int id) {
	        ...
	        if(!ThePurgeArena.instance.getConfig().getBoolean("enable-update-check")) {
	        	System.out.println("[PurgeArena] Update checking is disabled.");
	        ...
	        public void run() {
	            if (UpdateCheck.this.url != null) {
	                ...
	                if (UpdateCheck.this.read()) {
	                	if(!ThePurgeArena.version.equals(UpdateCheck.this.versionName)) {
