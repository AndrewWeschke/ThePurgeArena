...
private static boolean usePermission = ThePurgeArena.instance.getConfig().getBoolean("use-permissions");
	
	public static void reinitializeUsePermission() {
		usePermission = ThePurgeArena.instance.getConfig().getBoolean("use-permissions");
	}
